...
int main()
{
  ...
  cout << "Before cloning a sheep we have " << Pet::getNumberOfPets() << " pets." << endl;

  Pet dolly{ sheep };
  dolly.greet();

  // Hmm, this gives the same number of pets as before, although we created a new pet in the variable dolly :(
  cout << "After cloning a sheep we have " << Pet::getNumberOfPets() << " pets." << endl;
