...
#define REDUCE_FRACTION 0
#define COPY_ASSIGNMENT 0
#define OUT_OPERATOR 0
#define PLUS_OPERATORS 0
#define PLUS_OPERATORS_WITH_INT 0
#define INCREMENT_OPERATORS 0
#define NEGATION_INVERSION_DIVISION 0
#define BOOL_OPERATOR 0
